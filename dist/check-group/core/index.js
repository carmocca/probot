...
var CheckGroup = /** @class */ (function () {
    function CheckGroup(pullRequestNumber, config, context, sha, startTime) {
    ...
    CheckGroup.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var filenames, subprojs, expectedChecks, postedChecks, conclusion, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, this.postFailingCheck(this.config.customServiceName, config_1.errorCheckTitle, config_1.errorCheckSummary, config_1.errorCheckDetails)];
                    case 12:
                        // TODO(@tianhaoz95): Add a better error message. Consider using
                        // markdown import suggested by
                        // https://stackoverflow.com/questions/44678315/how-to-import-markdown-md-file-in-typescript
     ...
     */
    CheckGroup.prototype.postStartingCheck = function (name, title, summary, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
    ...
    CheckGroup.prototype.postUpdatingCheck = function (name, title, summary, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
    ...
    CheckGroup.prototype.postPassingCheck = function (name, title, summary, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
    ...
    CheckGroup.prototype.postFailingCheck = function (name, title, summary, details) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
